...
async function scrapeWebsite(url) {
  ...
  await page.waitForSelector("#highlights");

  const spanArray = await page.$$("#highlights");
  ...
  const countryName = await page.evaluate(() => {
    const span = document.querySelectorAll(".row eventRow");
    if (span != null) {
...
scrapeWebsite("https://www.betway.co.za/sport/tennis");
